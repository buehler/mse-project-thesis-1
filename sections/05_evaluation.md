...
6. Security Misconfiguration: The mesh does not directly influence used authentication schemes. However, the translators are directly responsible to use the correct HTTP headers for the target authentication mechanism. Deverlopers of translatores are therefore responsible to correctly implement the authentication schemes.
